...
#define FIREBASE_HOST "cevha-4f632.firebaseio.com"                     //Your Firebase Project URL goes here without "http:" , "\" and "/"
#define FIREBASE_AUTH "nSqlp4v21slseqk5OqRkuRCaozqoDC0xzHxvqM5E"       //Your Firebase Database Secret goes here
#define WIFI_SSID "desktop"             //your WiFi SSID for which yout NodeMCU connects
#define WIFI_PASSWORD "qwertyuiop"        //Password of your wifi network 
